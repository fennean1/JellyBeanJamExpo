...
export default class Swappables extends Component<{}> {
  constructor(props) {
    ...
    this.otherSwapImage = imageType.REDJELLYBEAN;
    this.isCandy = false
    this.currentIJ = {}
    this.nextIJ = {}
  ...
  swap(i, j, dx, dy) {
    ...
    this.otherSwapImage = swapEnder.imageType
    this.isCandy = isCandy(swapStarter.imageType)
    console.log("this is candy?",this.isCandy)
  ...
  updateGrid() {
    ...
    let crunchTheseIfCandy = this.getIndexesWithColor(this.otherSwapImage)
    console.log("this is the currentIJ",this.nextIJ)
    crunchTheseIfCandy.push(this.nextIJ)
    console.log("Indexes with this color",crunchTheseIfCandy)

    let allMatches = this.allMatchesOnBoard();

    if (this.isCandy){
        this.animateCandyCrunch(crunchTheseIfCandy)
      setTimeout(()=> {
        this.recolorMatches(crunchTheseIfCandy)
        this.condenseColumns(crunchTheseIfCandy)
      ...
      if (duplicates.length == 1) {
        ...
        console.log("withoutSharedIndexes",withoutSharedIndexes)
